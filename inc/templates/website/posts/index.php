...
<?php \HamyarSaz\core\helpers::template( 'header',['title'=>'مقالات']); ?>
            ...
            <div class="card">
                ...
                <div class="card-reveal" style="display: none; transform: translateY(0%);">
                    ...
                    <ul class="">
                        ...
                        <li><a class="col s12 btn mb-8 waves-effect waves-light" href="/hamsaz/posts/edit/<?php the_ID(); ?>/"  >ویرایش</a></li>
                        <li>
                            <form method="post">
                                <?php wp_nonce_field() ?>
